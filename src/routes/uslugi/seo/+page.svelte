<script>
	...
	const works = [
		...
		},
		{
			...
			d: 'Тексты под интент: отвечаем на вопрос человека. H1, Title, Description, Schema.org, перелинковка между кластерами.'
		},
		{
	...
	const faq = [
		...
		},
		{
			...
			a: 'Нет, и никто не может: позиции определяет алгоритм поисковой системы. Мы фиксируем плановые показатели по видимости, трафику и обращениям и отвечаем за них. Любая «гарантия ТОП-1» на рынке – это либо продвижение по мусорным запросам, либо мелкий шрифт в договоре.'
		},
		{
		...
		},
		{
			...
			a: 'Офис в Петербурге, но проекты ведём по всей России: среди текущих есть Москва, регионы и федеральные направления. Регион влияет только на семантику и список конкурентов.'
		}
	];
...
<Seo
	title="SEO-продвижение сайтов в Санкт-Петербурге – цены от 50 000 ₽ | Фальков"
		...
		<div class="container">
			...
			<div class="shead__grid">
				<div>
					...
					<p class="lead">
						Выводим коммерческие запросы в топ Яндекса и Google и отвечаем за трафик и обращения.
						Позиции наших проектов можно проверить руками – мы для этого
