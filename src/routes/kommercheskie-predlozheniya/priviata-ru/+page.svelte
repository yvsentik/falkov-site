	...
	const plan = [
		...
		},
		{
			...
			body: [
				...
				'Как это выглядит: текущий канал никуда не годится, в нём нет понятной линии продаж, контент-плана и одинаковой структуры ведения постов. Создаём в нём понятную воронку продаж, раскрываем преимущества, отвечаем на основные боли других частных школ и бюджетных учреждений. Контент преимущественно живой: фотографии из жизни школы и анонсы. В идеале делаем лицо бренда, чтобы канал вёлся от лица конкретного человека. Это не принуждает к блогерству, но раз в две недели нужно будет сфотографировать что-то в школе под новость.'
			],
