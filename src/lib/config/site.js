...
export const site = {
	...
	// 14.09.2026 токен перевыпущен и переезжает на хостинг (api/lead.php). До переезда форма
	// работает через открытие чата с менеджером, чтобы заявки не терялись.
	telegramBot: { token: '', chatId: '7315203539' },
